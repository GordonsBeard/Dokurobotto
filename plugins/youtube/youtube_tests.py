...
class TestYouTubeSearch(unittest.TestCase):
    ...
    prvmsg = "PRIVMSG"
    test_simple_query = "!yt drgamez"
    valid_return = '\x02*** YouTube: \x02\x02\x1f5 Stages of PSN Loss\x1f\x02 (145")'
    ...
    def test_valid_search(self):
        ...
        cleaned = self._clean_pretty(ytsearch.pretty[1])
...
class TestYouTubeIdent(unittest.TestCase):
    ...
    def test_valid_url(self):
        ...
        self.assertEqual(self._clean_pretty(ytident.pretty[0]), self.valid_response)
    ...
    def test_invalid_url(self):
        ...
        ytident = YouTubeIdent(valid_message_event)
        self.assertEqual(type(ytident.pretty[0]), HTTPError)
    ...
    def test_private_message_not_increasing_viewcount(self):
        ...
        regex = ".\(post (\d+)\)"
        rx = re.compile(regex)
        rd = rx.search(ytident1.pretty[0])
